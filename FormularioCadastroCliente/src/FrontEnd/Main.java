...
public class Main extends javax.swing.JFrame {
    ...
    public Main() {
        ...
        dtm.addColumn("Nome");
        dtm.addColumn("CPF");
        dtm.addColumn("Data de Nascimento");
        dtm.addColumn("Endereço");
        dtm.addColumn("Altura");
        dtm.addColumn("Peso");
        dtm.addColumn("Observações");
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Nome", "CPF", "Data de Nascimento", "Endereço", "Altura", "Peso", "Observações"
            }
        ));
        ...
        jFormattedTextField1.setMinimumSize(new java.awt.Dimension(64, 25));
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            ...
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                                    .addComponent(jTextField5, javax.swing.GroupLayout.PREFERRED_SIZE, 697, javax.swing.GroupLayout.PREFERRED_SIZE)
                                    .addGroup(layout.createSequentialGroup()
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try{
            float b;
            if (jFormattedTextField1.getText().equals("   .   .   -  ") == true) {
                JOptionPane.showMessageDialog(this, "Preencher o CPF");
                jFormattedTextField1.requestFocus();
            }
            else if (jFormattedTextField2.getText().equals("  /  /    ") == true) {
                ...
                JOptionPane.showMessageDialog(this, "Preencher o endereço");
                jTextField2.requestFocus();
            }
            else if (jTextField3.getText().isEmpty() == true) {
                JOptionPane.showMessageDialog(this, "Preencher a altura");
                jTextField3.requestFocus();
            }
            else if (jTextField4.getText().isEmpty() == true) {
                JOptionPane.showMessageDialog(this, "Preencher o peso");
            ...
            if (a == 1){
                JOptionPane.showMessageDialog(this, "A altura deve ser um valor númerico");
                jTextField3.requestFocus();
            }
            else if (a == 2){
                JOptionPane.showMessageDialog(this, "O peso deve ser um valor númerico");
                jTextField4.requestFocus();
            }
        }
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        if (jTable1.getRowCount() > 0) {
            if (jTable1.getSelectedRowCount() > 0) {
                String nome = dtm.getValueAt(jTable1.getSelectedRow(), 0).toString();
                
                int r = JOptionPane.showConfirmDialog(this,"Deseja excluir o paciente: " + nome + "?", "Excluir", JOptionPane.YES_NO_OPTION);
                ...
                JOptionPane.showMessageDialog(this,"Selecionar um paciente para excluir");
            }
        }
        else {
